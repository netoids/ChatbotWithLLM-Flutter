...
class EnterPage2 extends StatefulWidget {
  const EnterPage2({super.key});
  static const routeName = '/EnterPage2';

  @override
  State<EnterPage2> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<EnterPage2> {
